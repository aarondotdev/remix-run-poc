...
export const meta: MetaFunction = () => {
  return [
    { title: "Manage Cashiers - Cage System" },
    {
      property: "og:title",
    ...
    {
      name: "description",
      content: "Betrnk Cage Manage Cashiers",
    },
  ];
};
...
export const loader: LoaderFunction = async ({ request }) => {
  ...
  const url = `${API_BASE_URL}/admin/cashiers/${queryString}`;
  ...
  return (
    <PageContainer>
      <div className="space-y-4">
        ...
        <Heading title="Cashiers" description={`Total Items ${total}`} />
